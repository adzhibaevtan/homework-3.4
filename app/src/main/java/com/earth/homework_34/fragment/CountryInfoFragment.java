package com.earth.homework_34.fragment;
...
import com.earth.homework_34.adapter.CountryAdapter;
import com.earth.homework_34.databinding.FragmentCountryInfoBinding;
    ...
    private void getContinentsCountries() {
        ...
        if (getArguments() != null) {
            switch (getArguments().getString("continentName")) {
                case "Eurasia":
                    countryList.add(new Country("Kyrgyzstan", "Bishkek", "https://user-images.githubusercontent.com/98197909/197189647-5e15b8f1-2f62-4cf9-ac7b-9587cff24266.png"));
